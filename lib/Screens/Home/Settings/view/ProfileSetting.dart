                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(myModel!.data!.cityDetails!.name! + ', ' + myModel!.data!.stateDetails!.name! + ', ' + myModel!.data!.countryDetails!.name!,
                                        style: TextStyle(
                                            color: grey_aaaaaa,
                                            fontWeight: FontWeight.w500,
                                            fontFamily: "NeueHelvetica",
                                ...
                                GestureDetector(
                                  onTap: (){
                                    checkNet(context).then((value) {
                                      admireProfileController.userProfileAPI(context);
                                    });
                                  },
                                  child: Container(
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Hide yourself for a while",
                                          style: TextStyle(
                                              color: grey_aaaaaa,
                                              fontWeight: FontWeight.w500,
                                              fontFamily: "NeueHelvetica",
                                ...
                                FlutterSwitch(
                                  ...
                                  valueFontSize: 0.0,
                                  toggleSize: 15.0,
                                  value: controller.visible.value == 1 ? false : true,
                                  borderRadius: 15.0,
                                  padding: 2.0,
                                  showOnOff: true,
                                  onToggle: (val) {
                                    setState(() {
                                      ...
                                      stepsController.personalInfoAPI(context, 'profile_setting',controller.visible.value);
                                    });
                                  },
                                ),
                              ],
