          ...
          child: Column(
            children: [
              ...
              SizedBox(
                  ...
                  child: ToolbarWithHeaderCenterTitle("ABOUT ME",
                      onTap: _onWillpop)),
              SizedBox(
                                                              ...
                                                              child: Text(
                                                                  ...
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  style: TextStyle(
                                                                      color: stepsController.companyName.value == 'Company Name'
                                                                          ? grey_aaaaaa
                                                                          : black_121212,
                                                                      fontWeight:
                                                                          FontWeight
                                                            ...
                                                            child: stepsController
                                                                ...
                                                                : ClipRRect(
                                                                    ...
                                                                    child: stepsController
                                                                        ...
                                                                        ? CachedNetworkImage(
                                                                            imageUrl:
                                                                                stepsController.companyImage.value,
                                                                            width:
                                                                                25.w,
                                                                            height:
                                                                                25.h,
                                                                      ...
                                                                      children: [
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            // Company name
                                                                            Text("Company name",
                                                                                style: TextStyle(color: grey_aaaaaa, fontWeight: FontWeight.w500, fontFamily: helveticaNeueNeue_medium, fontStyle: FontStyle.normal, fontSize: 10.sp),
                                                                                textAlign: TextAlign.left),
                                                                            SizedBox(
                                                                              height: 5.h,
                                                                            ),
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Text(pastCompanyNameController[index].text,
                                                                                  style: TextStyle(
                                                                                    color: black_121212,
                                                                        ...
                                                                        pastJobImage[index].isEmpty
                                                                            ...
                                                                            : CachedNetworkImage(
                                                                                ...
                                                                                height: 25.h,
                                                                                fit: BoxFit.cover,
                                                                                progressIndicatorBuilder: (context, url, downloadProgress) => SvgPicture.asset(
                                                                                  placeholder,
                                                                                  width: 25.w,
                                                                                  height: 25.h,
                                                                                  fit: BoxFit.cover,
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          () async {
                                                                            if (startyearController[index].text.isEmpty) {
                                                                              ...
                                                                              endyearController[index].text = formattedDate;
                                                                            }
                                                                          },
                                                                        ),
                                                                      ),
                                      ...
                                      onTap: () {
                                        setState(() {
                                          if (universityController
                                              ...
                                              '') {
                                            snackBar(
                                                context, 'Enter university');
                                          } else if (startyearController
                                                  .last.value.text ==
                                              '') {
                                            snackBar(
                                                context, 'Enter start year');
