...
class _FeaturedMainScreenState extends State<FeaturedMainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() => featuredController.isDataFetched == true
          ? featuredController.featuredList.length > 0
              ? Stack(
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        CachedNetworkImage(
                          imageUrl:
                              featuredController.featuredList[0].image ?? "",
                          fit: BoxFit.cover,
                        ...
                        Center(
                          child: Text(
                              featuredController.featuredList[0].writer_name ??
                                  "",
                              style: TextStyle(
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          bottom: 50.w, left: 32.w, right: 32.w),
                      child: Container(
          ...
          : Stack(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsets.only(bottom: 50.w, left: 32.w, right: 32.w),
                  child: Container(
                    // color: Colors.lightBlueAccent,
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
  ...
  Route _createRoute() {
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) =>
          PastFeaturesScreen(
        featureList: featuredController.featuredList.value,
        selectedPosition: 0,
      ),
