...
SpeakerVideoModel speakerVideoModelFromJson(String str) =>
    SpeakerVideoModel.fromJson(json.decode(str));

String speakerVideoModelToJson(SpeakerVideoModel data) =>
    json.encode(data.toJson());

class SpeakerVideoModel {
  SpeakerVideoModel({
    this.success,
    this.statusCode,
    this.message,
...
class VideoList {
  ...
  factory VideoList.fromJson(Map<String, dynamic> json) => VideoList(
        ...
        isFocus: json["is_focus"] == null ? null : json["is_focus"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "is_focus": isFocus == null ? null : isFocus,
      };
}
