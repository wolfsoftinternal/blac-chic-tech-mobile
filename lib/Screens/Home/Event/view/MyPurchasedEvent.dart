    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          /*----- 2 Tab Layout ------*/
          Container(
            margin: EdgeInsets.only(left: 24.w, right: 24.w, top: 20.w, bottom: 24.h),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: ListView.builder(
                    ...
                    primary: false,
                    itemCount: _isFirstLayout == true ? controller.upcomingEventList.length : controller.pastEventList.length,
                                ...
                                child: Stack(
                                  children: [
                                    SizedBox(
                                      ...
                                      height: 207.h,
                                      child: _isFirstLayout == true ? controller.upcomingEventList[i].poster == null
                                          ? ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                          controller.upcomingEventList[i].poster!,
                                          fit: BoxFit.cover,
                                          width: MediaQuery.of(context)
                                              .size
                                              .width,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Center(
                                                child: Text(_isFirstLayout == true ?
                                                  controller.upcomingEventList[i].type! : controller.pastEventList[i].type!,
                                                  style:  TextStyle(
                                                      fontSize: 12.sp,
                                                      color: Colors.white,
                                                      fontFamily: roboto_bold),
                                            ...
                                            Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    setHelceticaBold(_isFirstLayout == true ?
                                                        controller.upcomingEventList[i]
                                                            .hosts![0]
                                                            .firstName! +
                                                            controller.upcomingEventList[i]
                                                                .hosts![0]
                                                                .lastName! : controller.pastEventList[i]
                                                            .hosts![0]
                                                            .firstName! +
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Padding(
                                                padding:  EdgeInsets.only(
                                                    left: 4.w),
                                                child: setHelveticaMedium(_isFirstLayout == true ?
                                            ...
                                            children: [
                                              Padding(
                                                padding:  EdgeInsets.only(
                                                    right: 4.w),
                                                child: setHelveticaMedium(_isFirstLayout == true ?
                                                    controller.upcomingEventList[i].venue! : controller.pastEventList[i].venue!,
                                                    10.sp,
                                                    white_ffffff,
                                                    FontWeight.w100,
                                                    FontStyle.normal,
                                    ...
                                    Positioned(
                                        ...
                                        child: Padding(
                                          padding:
                                           EdgeInsets.only(left: 16.w),
                                          child: setHelceticaBold(_isFirstLayout == true ?
                                              controller.upcomingEventList[i].title! : controller.pastEventList[i].title!,
                                              22.sp,
                                              white_ffffff,
                                              FontWeight.w500,
                                              FontStyle.normal,
