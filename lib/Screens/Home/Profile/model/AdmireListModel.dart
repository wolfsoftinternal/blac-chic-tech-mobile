...
class AdmireList {
    ...
    factory AdmireList.fromJson(Map<String, dynamic> json) => AdmireList(
        ...
        admireDetails: AdmireDetails.fromJson(json["admire_details"]),
    );
...
class AdmireDetails {
    ...
    factory AdmireDetails.fromJson(Map<String, dynamic> json) => AdmireDetails(
        ...
        questions: json["past_jobs"] == null ? null : List<Question>.from(json["questions"].map((x) => Question.fromJson(x))),
